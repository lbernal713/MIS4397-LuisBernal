...
class DealershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dealership" do
    assert_difference('Dealership.count') do
      post dealerships_url, params: { dealership: { address: @dealership.address, city: @dealership.city, name: @dealership.name, phone_number: @dealership.phone_number, state: @dealership.state, zip: @dealership.zip } }
    end
  ...
  test "should update dealership" do
    patch dealership_url(@dealership), params: { dealership: { address: @dealership.address, city: @dealership.city, name: @dealership.name, phone_number: @dealership.phone_number, state: @dealership.state, zip: @dealership.zip } }
